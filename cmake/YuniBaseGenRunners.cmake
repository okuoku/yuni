...
macro(yunibase_check_implementations)
    ...
    # Gambit(GSI)
    if(EXISTS ${YUNI_WITH_YUNIBASE}/stable/gambit/bin/gsi)
        set(YUNIBASE_HAVE_GAMBIT_STABLE 1)
    endif()
    # MIT/GNU Scheme
...
function(emit_yunibase_runners)
    ...
    if(YUNI_WITH_YUNIBASE AND YUNIBASE_VANILLA_PATH)
        ...
        if(YUNIBASE_HAVE_GAMBIT_STABLE)
    ...
    if(YUNI_WITH_YUNIBASE AND YUNIBASE_YUNIFIED_PATH)
        ...
        if(YUNIBASE_HAVE_GAMBIT_STABLE)
            emit_yunified_runner_sh(GAMBIT stable gambit gsi)
        endif()
        if(YUNIBASE_HAVE_MIT_SCHEME_CURRENT)
