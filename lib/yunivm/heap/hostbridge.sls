...
(define (make-hostbridge coreops)
  ...
  (define op-boolean? (coreops 'boolean?))
  (define op-true? (coreops 'true?))
  (define op-false? (coreops 'false?))
  (define op-char? (coreops 'char?))
  (define op-integer->char (coreops 'integer->char))
  (define op-char->integer (coreops 'char->integer))
  (define op-string? (coreops 'string?))
  ...
  (define op-bytevector? (coreops 'bytevector?))
  ...
  (define op-simple-struct? (coreops 'simple-struct?))
